package br.ufc.lps.service.imp;
...
import br.ufc.lps.service.ModelService;
...
public abstract class ModelServiceImp implements ModelService{
	...
	public ModelServiceImp(){}
	
	public ModelServiceImp(String pathModelFile, int modelID) {
